  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 text-sm text-muted-foreground">
        ...
        <ChevronLeft className="size-4 rotate-180" />
        <Link to="/lessons/island1" className="hover:text-foreground flex items-center gap-1">
...
export const Route = createFileRoute("/lessons/island1/$module")({
  loader: async ({ params }) => {
    if (!JUNGLE_MODULES.includes(params.module)) {
      throw notFound();
    }
