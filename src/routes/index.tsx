    ...
    <div className="flex flex-col items-center gap-20 md:gap-24 lg:gap-28 text-center">
      ...
      <div className="w-full max-w-6xl space-y-12">
        <div className="text-center space-y-6">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Four legendary tools forged by blockchain masters. Whether
            you&apos;re starting your journey or sharpening your skills, these
            treasures will guide you to EVM mastery.
          </p>
        </div>
        ...
        <Card className="group relative overflow-hidden border backdrop-blur hover:shadow-2xl transition-all duration-500">
          <div className="absolute inset-0 " />
            ...
            <div className="space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className=" rounded-xl p-6 border  text-center">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Complete modules and earn unique achievement NFTs that
                      prove your EVM mastery to the world
                    </p>
                  </div>
                  ...
                  <div className="rounded-xl p-6 border  text-center">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Learn from real-world exploits and vulnerabilities with
                  ...
                  <div className=" rounded-xl p-6 border text-center">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Build and launch production-ready smart contracts on
                      Zilliqa mainnet
                    </p>
                  </div>
                </div>
              ...
              <div className="space-y-4 pt-4">
                <Button
                  size="lg"
                  asChild
                  className="bg-gradient-to-r from-primary via-primary/90 to-primary text-white text-lg px-8 py-6 w-full"
                >
                  <Link to="/lessons">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
          {/* Deep Articles */}
          <Card className="group relative overflow-hidden border-2 backdrop-blur-sm hover:shadow-xl transition-all duration-300 hover:scale-105">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(16,185,129,0.15)_0%,transparent_70%)]" />
            <CardHeader className="relative pb-6">
              <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center shadow-lg mb-4">
                <BookOpen className="size-7 text-white" />
              </div>
              <CardTitle className="text-xl font-bold mb-3 text-left group-hover:text-emerald-600 transition-colors">
                📖 Knowledge Vault
              </CardTitle>
          ...
          <Card className="group relative overflow-hidden border-2 backdrop-blur-sm hover:shadow-xl transition-all duration-300 hover:scale-105">
            ...
            <CardHeader className="relative pb-6">
              <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-purple-500 to-pink-600 flex items-center justify-center shadow-lg mb-4 relative">
              ...
              <CardTitle className="text-xl font-bold mb-3 text-left group-hover:text-purple-600 transition-colors">
                🤖 AI Security Mate
              </CardTitle>
              <CardDescription className="text-left leading-relaxed">
          ...
          <Card className="group relative overflow-hidden border-2  backdrop-blur-sm hover:shadow-xl transition-all duration-300 hover:scale-105">
            ...
            <CardHeader className="relative pb-6">
              <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-orange-500 to-red-600 flex items-center justify-center shadow-lg mb-4">
                <MessageCircle className="size-7 text-white" />
              </div>
              <CardTitle className="text-xl font-bold mb-3 text-left group-hover:text-orange-600 transition-colors">
                💬 Wise Oracle
              </CardTitle>
              <CardDescription className="text-left leading-relaxed">
      ...
      <div className="w-full max-w-6xl space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
          <Card className="group relative overflow-hidden border-2 backdrop-blur-sm hover:shadow-xl transition-all duration-300">
            ...
            <CardHeader className="relative">
              ...
              <CardTitle className="text-xl text-left font-bold mb-2 group-hover:text-red-600 transition-colors">
          ...
          <Card className="group relative overflow-hidden border-2 backdrop-blur-sm hover:shadow-xl transition-all duration-300">
            ...
            <CardHeader className="relative">
              ...
              <CardTitle className="text-xl text-left font-bold mb-2 group-hover:text-blue-600 transition-colors">
          ...
          <Card className="group relative overflow-hidden border-2 backdrop-blur-sm hover:shadow-xl transition-all duration-300">
            ...
            <CardHeader className="relative">
              ...
              <CardTitle className="text-xl text-left font-bold mb-2 group-hover:text-purple-600 transition-colors">
                🤖 AI-Powered Learning
              </CardTitle>
              <CardDescription className="leading-relaxed text-left">
          ...
          <Card className="group relative overflow-hidden border-2 backdrop-blur-sm hover:shadow-xl transition-all duration-300">
            ...
            <CardHeader className="relative">
              ...
              <CardTitle className="text-xl text-left font-bold mb-2 group-hover:text-emerald-600 transition-colors">
                📈 Complete Journey
              </CardTitle>
              <CardDescription className="leading-relaxed text-left">
      ...
      <div className="w-full max-w-6xl grid grid-cols-1 items-center gap-8 rounded-xl border p-6 text-left md:grid-cols-2">
        <div className="space-y-4">
          ...
          <p className="text-muted-foreground">
            Connect with RainbowKit and wagmi. Use the Zilliqa EVM chain via
            viem for a familiar developer experience with fast finality.
          </p>
          ...
          <div className="flex gap-3 pt-2">
            <Button asChild>
              <Link to="/reviewer">Review your contract</Link>
            </Button>
            <Button variant="secondary" asChild>
              <Link to="/chat">Ask about Zilliqa</Link>
            </Button>
          </div>
        </div>
        <div>
