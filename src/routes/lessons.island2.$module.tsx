    ...
    >
      <div className="mx-auto max-w-6xl space-y-8">
        ...
        <div className="flex items-center gap-2 text-sm text-muted-foreground">
          ...
          <ChevronLeft className="size-4 rotate-180" />
          <Link to="/lessons/island2" className="hover:text-foreground flex items-center gap-1">
...
export const Route = createFileRoute("/lessons/island2/$module")({
  loader: async ({ params }) => {
    if (!FROST_MODULES.includes(params.module)) {
      throw notFound();
    }
