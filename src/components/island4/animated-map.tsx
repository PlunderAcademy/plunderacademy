...
const pathPoints = [
  ...
  { x: 62, y: 48, label: "Dome Building (Middle Right)", progress: 32 },   // 3: Dome building to the right of church
  { x: 41, y: 43, label: "Church (Top Middle)", progress: 45 },            // 4: Church top middle
  { x: 22, y: 17, label: "Lighthouse (Top Left)", progress: 68 },          // 5: Lighthouse top left
  ...
  switch (state) {
    ...
    case "available":
      return {
        ...
        stroke: "#1f2937",
        text: "#f3f4f6",
        halo: "rgba(75, 85, 99, 0.35)",
        shadow: "0 0 10px rgba(75, 85, 99, 0.45)",
      };
    case "locked":
    default:
      return {
