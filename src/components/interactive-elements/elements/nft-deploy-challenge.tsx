...
export function NftDeployChallenge({ moduleSlug, missionData }: DeployElementProps) {
  ...
  const handleSubmit = useCallback(async () => {
    ...
    const submissionData = {
      ...
      method: 'deployment' as const // NFT contract only supports full deployment
    };
    ...
    try {
      ...
      if (apiResult.results) {
        ...
        // Always set apiResults so error messages can be displayed
        ...
        if (deployResult.passed && apiResult.voucher && apiResult.signature && apiResult.contractAddress && apiResult.chainId) {
          ...
          // For failed submissions, also set the transaction error for the form
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
            <div className="w-full max-w-lg max-h-[90vh] overflow-y-auto overflow-x-hidden px-2 py-4">
              <ModuleCompletionFeedback
                moduleSlug={moduleSlug}
                achievementCodes={[getAchievementNumber(moduleSlug) || "0033"]}
                onComplete={() => {
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            Submit Your NFT Collection Deployment
          </CardTitle>
        </CardHeader>
        <CardContent className="space-y-6">
          <p className="text-muted-foreground">
            Deploy your NFT collection contract using the Hardhat environment from the lesson, then submit your deployment transaction ID to earn your achievement.
          </p>
          ...
          <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 p-4 rounded-lg">
            ...
            <p className="text-xs text-green-600 dark:text-green-400 mt-1">
              Use this address as the claimant parameter when deploying your NFT collection contract.
            </p>
          </div>
          
          <div className="bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 p-4 rounded-lg">
            <h4 className="font-semibold text-orange-800 dark:text-orange-200 mb-2">📝 Deployment Requirements:</h4>
            <ul className="text-sm text-orange-700 dark:text-orange-300 space-y-2 list-disc list-inside">
              <li>Deploy the complete NFT collection contract from the lesson</li>
          ...
          <div className="bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800 p-4 rounded-lg">
            ...
            <ul className="text-sm text-purple-700 dark:text-purple-300 space-y-1 list-disc list-inside">
              ...
              <li>Metadata and reveal mechanics</li>
              <li>IPFS integration for decentralized storage</li>
              <li>Minting controls and payment handling</li>
              <li>Production-ready NFT collection deployment</li>
            </ul>
          </div>
      ...
      <CardContent className="space-y-6">
        <div className="space-y-4">
            ...
            {selectedChain === 'mainnet' && (
              <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 p-3 rounded-lg">
                ...
                <ul className="text-xs text-red-700 dark:text-red-300 space-y-1 list-disc list-inside">
                  ...
                  <li>Your NFT collection will be permanently deployed to mainnet</li>
                  <li>Consider testing on testnet first</li>
                  <li>Only proceed if you intend to deploy a production NFT collection</li>
                </ul>
              </div>
            )}
          </div>
          ...
          <div className="bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 p-3 rounded-lg">
            <p className="text-sm font-medium text-orange-800 dark:text-orange-200 mb-1">🛠️ Deployment Instructions:</p>
          ...
          <div className="text-xs text-muted-foreground bg-muted/30 p-3 rounded-lg">
            ...
            <ul className="space-y-1 list-disc list-inside">
              <li>We&apos;ll verify this transaction deployed a valid NFT collection contract</li>
              <li>The contract must implement ERC-721 standard functions</li>
