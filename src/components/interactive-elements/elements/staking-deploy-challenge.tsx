...
export function StakingDeployChallenge({ moduleSlug, missionData }: DeployElementProps) {
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
            <div className="w-full max-w-lg max-h-[90vh] overflow-y-auto overflow-x-hidden px-2 py-4">
              <ModuleCompletionFeedback
                moduleSlug={moduleSlug}
                achievementCodes={[getAchievementNumber(moduleSlug) || "0025"]}
                onComplete={() => {
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            Submit Your Staking Contract Deployment
          </CardTitle>
        </CardHeader>
        <CardContent className="space-y-6">
          <p className="text-muted-foreground">
            Deploy your staking contract using the Hardhat environment from the lesson, then submit your deployment transaction ID to earn your achievement.
          </p>
          ...
          <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 p-4 rounded-lg">
            ...
            <p className="text-xs text-green-600 dark:text-green-400 mt-1">
              Use this address as the claimant parameter when deploying your staking contract.
            </p>
          </div>
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 p-4 rounded-lg">
            ...
            <ul className="text-sm text-blue-700 dark:text-blue-300 space-y-2 list-disc list-inside">
              <li>Deploy the complete staking contract from the lesson</li>
          ...
          <div className="bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800 p-4 rounded-lg">
            ...
            <ul className="text-sm text-purple-700 dark:text-purple-300 space-y-1 list-disc list-inside">
              <li>Time-locked staking with multiple duration tiers</li>
              <li>Reward calculations with APY</li>
              <li>Early withdrawal penalties</li>
              <li>Emergency pause functionality</li>
              <li>Production-ready contract deployment</li>
            </ul>
          </div>
        ...
        <div className="space-y-4">
            ...
            {selectedChain === 'mainnet' && (
              <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 p-3 rounded-lg">
                ...
                <ul className="text-xs text-red-700 dark:text-red-300 space-y-1 list-disc list-inside">
                  ...
                  <li>Your staking contract will be permanently deployed to mainnet</li>
                  <li>Consider testing on testnet first</li>
                  <li>Only proceed if you intend to deploy a production staking contract</li>
                </ul>
              </div>
            )}
          </div>
          ...
          <div className="text-xs text-muted-foreground bg-muted/30 p-3 rounded-lg">
            ...
            <ul className="space-y-1 list-disc list-inside">
              <li>We&apos;ll verify this transaction deployed a valid staking contract</li>
              <li>The contract claimant must be your connected wallet</li>
              <li>Transaction must be successful (not reverted)</li>
              <li>Transaction must be on the selected network</li>
              <li>Contract must implement the required staking functions</li>
            </ul>
          </div>
        </div>
