  ...
  return (
    <div className="space-y-4" data-interactive="true">
      <div className="grid md:grid-cols-[1fr_auto_1fr] gap-4">
        {/* Concepts */}
        <div>
          <p className="text-xs font-medium text-muted-foreground mb-2">Concepts (drag →)</p>
          <div className="space-y-2">
            {concepts.map((concept) => {
              ...
              return (
                <div
                  key={concept.id}
                  draggable={!isMatched && !isSubmitted}
                  ...
                  className={cn(
                    ...
                    isMatched 
                      ? mode === 'assessment'
                        ...
                        : matchStatus === 'correct'
                          ? "border-green-400 bg-green-50 dark:bg-green-900/20 cursor-pointer"
                          : "border-red-400 bg-red-50 dark:bg-red-900/20 cursor-pointer"
                      : "border-border cursor-move hover:shadow-md hover:border-primary/50",
                    !isMatched && !isSubmitted && "hover:scale-[1.02]"
                  )}
                  onClick={() => isMatched && !isSubmitted && handleRemoveMatch(concept.id)}
                >
        ...
        {/* Definitions */}
        <div>
          <p className="text-xs font-medium text-muted-foreground mb-2">Definitions (drop here)</p>
          <div className="space-y-2">
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between gap-2 w-full">
                    <span className={isMatched ? "font-medium" : "text-muted-foreground"}>{definition.content}</span>
                    {isMatched && showFeedback && mode === 'learning' && (
                      matchStatus === 'correct' ? (
                        <CheckCircle className="size-3 text-green-600 flex-shrink-0" />
                      ) : (
