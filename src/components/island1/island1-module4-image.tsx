    ...
    <Card className="relative overflow-hidden">
      <div className="relative w-full aspect-[16/9]">
        ...
        <video
          ...
          poster="/islands/island1/island1-module4-image.webp"
          onError={() => setVideoError(true)}
        >
          <source src="/islands/island1/island1-module4-video.mp4" type="video/mp4" />
        </video>
        
        {/* Fallback image shown only if video fails */}
        {videoError && (
          <Image
            src="/islands/island1/island1-module4-image.webp"
