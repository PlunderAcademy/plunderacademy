  ...
  return (
    <Card className="relative overflow-hidden">
      <div className="relative w-full aspect-[16/9]">
        ...
        {/* ULTIMATE FINALE ANIMATED EFFECTS - QUANTUM MATRIX REALM */}
        <div className="absolute inset-0 animate-effects">
          ...
          <div className="absolute inset-0">
            {/* Vertical beams */}
            <div className="absolute top-[18%] left-[52%] w-[3px] h-[120px] bg-gradient-to-b from-cyan-400/70 via-cyan-300/50 to-transparent energy-beam animate-beam-vertical-1"></div>
            <div className="absolute top-[54%] left-[52%] w-[3px] h-[120px] bg-gradient-to-t from-purple-400/70 via-purple-300/50 to-transparent energy-beam animate-beam-vertical-2"></div>
            
            {/* Diagonal beams - radiating out */}
            <div className="absolute top-[38%] left-[20%] w-[200px] h-[3px] bg-gradient-to-r from-transparent via-pink-400/65 to-cyan-400/40 energy-beam-h animate-beam-h-1"></div>
            <div className="absolute top-[48%] left-[55%] w-[200px] h-[3px] bg-gradient-to-l from-transparent via-cyan-400/65 to-purple-400/40 energy-beam-h animate-beam-h-2"></div>
            
            {/* Angled beams */}
            <div className="absolute top-[30%] left-[42%] w-[2px] h-[100px] bg-gradient-to-b from-purple-400/60 to-transparent energy-beam rotate-45 animate-beam-angle-1"></div>
            <div className="absolute top-[30%] left-[58%] w-[2px] h-[100px] bg-gradient-to-b from-cyan-400/60 to-transparent energy-beam -rotate-45 animate-beam-angle-2"></div>
          </div>

          {/* Quantum Data Streams - FLOWING EVERYWHERE */}
          <div className="absolute inset-0">
            {/* Top data streams flowing */}
            <div className="absolute top-[15%] left-[35%] w-[3px] h-[3px] bg-cyan-400/90 rounded-full data-stream animate-data-stream-1"></div>
            <div className="absolute top-[16%] left-[40%] w-[3px] h-[3px] bg-pink-400/88 rounded-full data-stream animate-data-stream-2"></div>
            <div className="absolute top-[14%] left-[45%] w-[3px] h-[3px] bg-purple-400/92 rounded-full data-stream animate-data-stream-3"></div>
            <div className="absolute top-[17%] left-[55%] w-[3px] h-[3px] bg-cyan-400/90 rounded-full data-stream animate-data-stream-4"></div>
            <div className="absolute top-[15%] left-[60%] w-[3px] h-[3px] bg-pink-400/88 rounded-full data-stream animate-data-stream-5"></div>
            <div className="absolute top-[16%] left-[65%] w-[3px] h-[3px] bg-purple-400/92 rounded-full data-stream animate-data-stream-6"></div>
            
            {/* Side data streams */}
            <div className="absolute top-[40%] left-[15%] w-[3px] h-[3px] bg-cyan-400/88 rounded-full data-stream animate-data-stream-7"></div>
            <div className="absolute top-[45%] left-[18%] w-[3px] h-[3px] bg-pink-400/90 rounded-full data-stream animate-data-stream-8"></div>
            <div className="absolute top-[42%] left-[80%] w-[3px] h-[3px] bg-purple-400/88 rounded-full data-stream animate-data-stream-9"></div>
            <div className="absolute top-[48%] left-[83%] w-[3px] h-[3px] bg-cyan-400/92 rounded-full data-stream animate-data-stream-10"></div>
            
            {/* Bottom streams */}
            <div className="absolute top-[70%] left-[30%] w-[3px] h-[3px] bg-pink-400/90 rounded-full data-stream animate-data-stream-11"></div>
            <div className="absolute top-[72%] left-[38%] w-[3px] h-[3px] bg-cyan-400/88 rounded-full data-stream animate-data-stream-12"></div>
            <div className="absolute top-[71%] left-[62%] w-[3px] h-[3px] bg-purple-400/90 rounded-full data-stream animate-data-stream-13"></div>
            <div className="absolute top-[73%] left-[70%] w-[3px] h-[3px] bg-cyan-400/92 rounded-full data-stream animate-data-stream-14"></div>
          </div>

          {/* Holographic Matrix Grid Lines - THE MATRIX */}
          <div className="absolute inset-0">
            {/* Horizontal grid lines */}
            <div className="absolute top-[25%] left-[10%] w-[80%] h-[1px] bg-gradient-to-r from-transparent via-cyan-400/35 to-transparent matrix-line animate-matrix-h-1"></div>
            <div className="absolute top-[35%] left-[10%] w-[80%] h-[1px] bg-gradient-to-r from-transparent via-purple-400/32 to-transparent matrix-line animate-matrix-h-2"></div>
            <div className="absolute top-[55%] left-[10%] w-[80%] h-[1px] bg-gradient-to-r from-transparent via-pink-400/30 to-transparent matrix-line animate-matrix-h-3"></div>
            <div className="absolute top-[65%] left-[10%] w-[80%] h-[1px] bg-gradient-to-r from-transparent via-cyan-400/33 to-transparent matrix-line animate-matrix-h-4"></div>
            
            {/* Vertical grid lines */}
            <div className="absolute top-[10%] left-[25%] w-[1px] h-[80%] bg-gradient-to-b from-transparent via-cyan-400/30 to-transparent matrix-line animate-matrix-v-1"></div>
            <div className="absolute top-[10%] left-[40%] w-[1px] h-[80%] bg-gradient-to-b from-transparent via-purple-400/28 to-transparent matrix-line animate-matrix-v-2"></div>
            <div className="absolute top-[10%] left-[60%] w-[1px] h-[80%] bg-gradient-to-b from-transparent via-pink-400/32 to-transparent matrix-line animate-matrix-v-3"></div>
            <div className="absolute top-[10%] left-[75%] w-[1px] h-[80%] bg-gradient-to-b from-transparent via-cyan-400/30 to-transparent matrix-line animate-matrix-v-4"></div>
          </div>

          {/* Building/Structure Neon Highlights */}
          <div className="absolute inset-0">
            {/* Left structure panels */}
            <div className="absolute top-[35%] left-[8%] w-[60px] h-[4px] bg-cyan-400/35 rounded-full structure-light animate-structure-1"></div>
            <div className="absolute top-[40%] left-[10%] w-[55px] h-[4px] bg-purple-400/32 rounded-full structure-light animate-structure-2"></div>
            <div className="absolute top-[45%] left-[8%] w-[58px] h-[4px] bg-pink-400/34 rounded-full structure-light animate-structure-3"></div>
            
            {/* Right structure panels */}
            <div className="absolute top-[38%] left-[85%] w-[60px] h-[4px] bg-cyan-400/35 rounded-full structure-light animate-structure-4"></div>
            <div className="absolute top-[43%] left-[87%] w-[55px] h-[4px] bg-purple-400/32 rounded-full structure-light animate-structure-5"></div>
            <div className="absolute top-[48%] left-[85%] w-[58px] h-[4px] bg-pink-400/34 rounded-full structure-light animate-structure-6"></div>
            
            {/* Vertical panel lights */}
            <div className="absolute top-[28%] left-[15%] w-[4px] h-[70px] bg-cyan-400/30 rounded-full structure-light animate-structure-7"></div>
            <div className="absolute top-[30%] left-[88%] w-[4px] h-[65px] bg-purple-400/28 rounded-full structure-light animate-structure-8"></div>
          </div>

          {/* Floor Panel Lights */}
          <div className="absolute inset-0">
            {/* Bottom floor grid lights */}
            <div className="absolute top-[75%] left-[28%] w-[8px] h-[8px] bg-cyan-400/75 rounded floor-light animate-floor-light-1"></div>
            <div className="absolute top-[78%] left-[33%] w-[8px] h-[8px] bg-purple-400/72 rounded floor-light animate-floor-light-2"></div>
            <div className="absolute top-[76%] left-[38%] w-[8px] h-[8px] bg-pink-400/78 rounded floor-light animate-floor-light-3"></div>
            <div className="absolute top-[79%] left-[43%] w-[8px] h-[8px] bg-cyan-400/75 rounded floor-light animate-floor-light-4"></div>
            <div className="absolute top-[77%] left-[48%] w-[8px] h-[8px] bg-purple-400/80 rounded floor-light animate-floor-light-5"></div>
            <div className="absolute top-[78%] left-[53%] w-[8px] h-[8px] bg-pink-400/76 rounded floor-light animate-floor-light-6"></div>
            <div className="absolute top-[76%] left-[58%] w-[8px] h-[8px] bg-cyan-400/78 rounded floor-light animate-floor-light-7"></div>
            <div className="absolute top-[79%] left-[63%] w-[8px] h-[8px] bg-purple-400/74 rounded floor-light animate-floor-light-8"></div>
            <div className="absolute top-[77%] left-[68%] w-[8px] h-[8px] bg-pink-400/80 rounded floor-light animate-floor-light-9"></div>
          </div>

          {/* Atmospheric Energy Particles - MASSIVE AMOUNT */}
          <div className="absolute inset-0">
            {/* Large quantum particles */}
            <div className="absolute top-[20%] left-[22%] w-[5px] h-[5px] bg-cyan-300/80 rounded-full quantum-particle animate-quantum-float-1"></div>
            <div className="absolute top-[24%] left-[30%] w-[5px] h-[5px] bg-pink-300/78 rounded-full quantum-particle animate-quantum-float-2"></div>
            <div className="absolute top-[28%] left-[70%] w-[6px] h-[6px] bg-purple-300/82 rounded-full quantum-particle animate-quantum-float-3"></div>
            <div className="absolute top-[32%] left-[78%] w-[5px] h-[5px] bg-cyan-400/80 rounded-full quantum-particle animate-quantum-float-4"></div>
            <div className="absolute top-[52%] left-[20%] w-[6px] h-[6px] bg-pink-400/82 rounded-full quantum-particle animate-quantum-float-5"></div>
            <div className="absolute top-[56%] left-[28%] w-[5px] h-[5px] bg-purple-400/78 rounded-full quantum-particle animate-quantum-float-6"></div>
            <div className="absolute top-[58%] left-[72%] w-[6px] h-[6px] bg-cyan-300/80 rounded-full quantum-particle animate-quantum-float-7"></div>
            <div className="absolute top-[62%] left-[80%] w-[5px] h-[5px] bg-pink-300/82 rounded-full quantum-particle animate-quantum-float-8"></div>
            
            {/* Medium particles */}
            <div className="absolute top-[22%] left-[26%] w-[3px] h-[3px] bg-cyan-400/75 rounded-full quantum-particle animate-quantum-float-9"></div>
            <div className="absolute top-[26%] left-[34%] w-[3px] h-[3px] bg-purple-400/72 rounded-full quantum-particle animate-quantum-float-10"></div>
            <div className="absolute top-[30%] left-[66%] w-[4px] h-[4px] bg-pink-400/78 rounded-full quantum-particle animate-quantum-float-11"></div>
            <div className="absolute top-[34%] left-[74%] w-[3px] h-[3px] bg-cyan-300/76 rounded-full quantum-particle animate-quantum-float-12"></div>
            <div className="absolute top-[54%] left-[24%] w-[4px] h-[4px] bg-purple-300/75 rounded-full quantum-particle animate-quantum-float-13"></div>
            <div className="absolute top-[60%] left-[76%] w-[3px] h-[3px] bg-cyan-400/78 rounded-full quantum-particle animate-quantum-float-14"></div>
            
            {/* Small glitter particles */}
            <div className="absolute top-[18%] left-[38%] w-[2px] h-[2px] bg-white/85 rounded-full quantum-particle animate-quantum-float-15"></div>
            <div className="absolute top-[23%] left-[50%] w-[2px] h-[2px] bg-cyan-200/88 rounded-full quantum-particle animate-quantum-float-16"></div>
            <div className="absolute top-[27%] left-[62%] w-[2px] h-[2px] bg-pink-200/82 rounded-full quantum-particle animate-quantum-float-17"></div>
            <div className="absolute top-[50%] left-[35%] w-[2px] h-[2px] bg-purple-200/85 rounded-full quantum-particle animate-quantum-float-18"></div>
            <div className="absolute top-[55%] left-[65%] w-[2px] h-[2px] bg-cyan-200/80 rounded-full quantum-particle animate-quantum-float-19"></div>
            <div className="absolute top-[64%] left-[45%] w-[2px] h-[2px] bg-white/88 rounded-full quantum-particle animate-quantum-float-20"></div>
          </div>

          {/* Portal Window Glows - TOP DISPLAYS */}
          <div className="absolute inset-0">
            {/* Top screen panels */}
            <div className="absolute top-[12%] left-[20%] w-[40px] h-[25px] bg-cyan-400/32 rounded portal-screen animate-portal-screen-1"></div>
            <div className="absolute top-[14%] left-[28%] w-[35px] h-[22px] bg-purple-400/30 rounded portal-screen animate-portal-screen-2"></div>
            <div className="absolute top-[12%] left-[66%] w-[40px] h-[25px] bg-pink-400/32 rounded portal-screen animate-portal-screen-3"></div>
            <div className="absolute top-[14%] left-[74%] w-[35px] h-[22px] bg-cyan-400/30 rounded portal-screen animate-portal-screen-4"></div>
            
            {/* Side monitor glows */}
            <div className="absolute top-[32%] left-[12%] w-[30px] h-[35px] bg-cyan-400/28 rounded portal-screen animate-portal-screen-5"></div>
            <div className="absolute top-[50%] left-[14%] w-[28px] h-[32px] bg-purple-400/26 rounded portal-screen animate-portal-screen-6"></div>
            <div className="absolute top-[35%] left-[88%] w-[30px] h-[35px] bg-pink-400/28 rounded portal-screen animate-portal-screen-7"></div>
            <div className="absolute top-[52%] left-[86%] w-[28px] h-[32px] bg-cyan-400/26 rounded portal-screen animate-portal-screen-8"></div>
          </div>

          {/* Electric Arcs - LIGHTNING BOLTS */}
          <div className="absolute inset-0">
            {/* Arc from core to left */}
            <div className="absolute top-[42%] left-[38%] w-[120px] h-[2px] bg-gradient-to-r from-cyan-400/70 via-white/80 to-transparent electric-arc animate-arc-1"></div>
            
            {/* Arc from core to right */}
            <div className="absolute top-[46%] left-[54%] w-[120px] h-[2px] bg-gradient-to-l from-purple-400/70 via-white/80 to-transparent electric-arc animate-arc-2"></div>
            
            {/* Arc from core upward */}
            <div className="absolute top-[28%] left-[51%] w-[2px] h-[80px] bg-gradient-to-b from-transparent via-pink-400/75 to-cyan-400/60 electric-arc animate-arc-3"></div>
            
            {/* Sparkle points on arcs */}
            <div className="absolute top-[42%] left-[42%] w-[4px] h-[4px] bg-white/95 rounded-full arc-spark animate-arc-spark-1"></div>
            <div className="absolute top-[46%] left-[62%] w-[4px] h-[4px] bg-cyan-200/95 rounded-full arc-spark animate-arc-spark-2"></div>
            <div className="absolute top-[32%] left-[51%] w-[4px] h-[4px] bg-pink-200/95 rounded-full arc-spark animate-arc-spark-3"></div>
          </div>

          {/* Floating Hologram Symbols/Runes */}
          <div className="absolute inset-0">
            {/* Hexagon holograms */}
            <div className="absolute top-[24%] left-[18%] w-[25px] h-[25px] border-2 border-cyan-400/55 rotate-0 hologram-symbol animate-hologram-symbol-1"></div>
            <div className="absolute top-[30%] left-[82%] w-[28px] h-[28px] border-2 border-purple-400/52 rotate-45 hologram-symbol animate-hologram-symbol-2"></div>
            <div className="absolute top-[60%] left-[20%] w-[26px] h-[26px] border-2 border-pink-400/54 hologram-symbol animate-hologram-symbol-3"></div>
            <div className="absolute top-[64%] left-[78%] w-[27px] h-[27px] border-2 border-cyan-400/50 rotate-30 hologram-symbol animate-hologram-symbol-4"></div>
            
            {/* Small triangular symbols */}
            <div className="absolute top-[28%] left-[38%] w-[15px] h-[15px] border-2 border-purple-400/60 rotate-45 hologram-symbol animate-hologram-symbol-5"></div>
            <div className="absolute top-[58%] left-[62%] w-[16px] h-[16px] border-2 border-cyan-400/58 -rotate-45 hologram-symbol animate-hologram-symbol-6"></div>
          </div>

          {/* Top Ceiling Lights/Panels */}
          <div className="absolute inset-0">
            <div className="absolute top-[8%] left-[30%] w-[5px] h-[5px] bg-cyan-400/85 rounded-full ceiling-light animate-ceiling-light-1"></div>
            <div className="absolute top-[10%] left-[38%] w-[5px] h-[5px] bg-purple-400/82 rounded-full ceiling-light animate-ceiling-light-2"></div>
            <div className="absolute top-[9%] left-[46%] w-[6px] h-[6px] bg-pink-400/88 rounded-full ceiling-light animate-ceiling-light-3"></div>
            <div className="absolute top-[8%] left-[54%] w-[6px] h-[6px] bg-cyan-400/88 rounded-full ceiling-light animate-ceiling-light-4"></div>
            <div className="absolute top-[10%] left-[62%] w-[5px] h-[5px] bg-purple-400/85 rounded-full ceiling-light animate-ceiling-light-5"></div>
            <div className="absolute top-[9%] left-[70%] w-[5px] h-[5px] bg-pink-400/82 rounded-full ceiling-light animate-ceiling-light-6"></div>
          </div>
        </div>
