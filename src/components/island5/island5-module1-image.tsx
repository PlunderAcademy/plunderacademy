    ...
    <Card className="relative overflow-hidden">
      <div className="relative w-full aspect-[16/9]">
        ...
        <video
          ...
          poster="/islands/island5/island5-module1-image.webp"
          onError={() => setVideoError(true)}
        >
          <source src="/islands/island5/island5-module1-video.mp4" type="video/mp4" />
        </video>
        ...
        {/* EPIC Animated overlay effects - Only shown if video fails */}
        {videoError && (
