...
const pathPoints = [
  { x: 20, y: 62, label: "Ship (Bottom Left)", progress: 0 },      // 1: Ship in bottom left
  { x: 25, y: 25, label: "Igloos (Top Left)", progress: 25 },      // 2: Igloos in top left
  { x: 50, y: 45, label: "Central Mountain", progress: 50 },       // 3: Stays where it is (center)
  { x: 75, y: 65, label: "Ice (Bottom Right)", progress: 75 },     // 4: Ice in bottom right
  { x: 80, y: 24, label: "Mammoth (Top Right)", progress: 100 },   // 5: Woolly mammoth top right
];
              ...
              <HoverCard key={`hover-${index}`}>
                ...
                <HoverCardContent className="w-96">
                  {isCompleted && mode === "real" ? (
                    // Completed - show achievement placeholder
