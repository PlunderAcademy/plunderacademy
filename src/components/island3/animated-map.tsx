...
interface IceAnimatedMapProps {
  mode?: "preview" | "real";
  modules: ModuleMeta[];
}

export function IceAnimatedMap({ mode = "real", modules }: IceAnimatedMapProps) {
  return (
          ...
          <div className="text-center space-y-6">
            ...
            <div className="space-y-3">
              <h3 className="text-2xl font-bold text-blue-800 dark:text-blue-200">
                Ice Island Interactive Map
              </h3>
              <p className="text-blue-600 dark:text-blue-400 max-w-md">
                Animated NFT launchpad featuring {modules.length} comprehensive modules for token creation and collection deployment.
              </p>
              <div className="pt-4">
