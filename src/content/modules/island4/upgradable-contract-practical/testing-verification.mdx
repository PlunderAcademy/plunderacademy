...
[⠊] Solc 0.8.28 finished in 2.43s
Compiler run successful!

Ran 27 tests for test/TrainingRegistryV1.t.sol:TrainingRegistryV1Test
[PASS] testBatchTransferReverts() (gas: 268765)
[PASS] testCannotInitializeTwice() (gas: 23039)
[PASS] testGetWalletAchievements() (gas: 373417)
[PASS] testHasAchievement() (gas: 159389)
[PASS] testImplementationCannotBeInitialized() (gas: 18781)
[PASS] testInitialization() (gas: 40230)
[PASS] testInitializeRevertsOnZeroClaimant() (gas: 2871853)
[PASS] testMultipleTasksSameUser() (gas: 606121)
[PASS] testOwnerCanUpgrade() (gas: 2666391)
[PASS] testPauseOnlyOwner() (gas: 19165)
[PASS] testPauseStopsSubmissions() (gas: 48728)
[PASS] testRemoveIssuer() (gas: 19151)
[PASS] testSetBaseURI() (gas: 43603)
[PASS] testSetIssuer() (gas: 42667)
[PASS] testSetIssuerOnlyOwner() (gas: 19154)
[PASS] testSetUriPadDigits() (gas: 36349)
[PASS] testSubmitVoucherEmitsEvent() (gas: 157768)
[PASS] testSubmitVoucherRevertsOnDoubleSubmit() (gas: 160913)
[PASS] testSubmitVoucherRevertsOnInvalidIssuer() (gas: 37334)
[PASS] testSubmitVoucherRevertsOnWalletMismatch() (gas: 37901)
[PASS] testSubmitVoucherSucceeds() (gas: 160244)
[PASS] testTransferOwnership() (gas: 36069)
[PASS] testTransferOwnershipOnlyOwner() (gas: 19254)
[PASS] testTransferReverts() (gas: 159397)
[PASS] testUnpauseAllowsSubmissions() (gas: 164986)
[PASS] testUpgradeOnlyOwner() (gas: 2656209)
[PASS] testUriPadding() (gas: 46795)
Suite result: ok. 27 passed; 0 failed; 0 skipped; finished in 3.37ms (46.66ms CPU time)

Ran 1 test suite in 27.46ms (3.37ms CPU time): 27 tests passed, 0 failed, 0 skipped (27 total tests)
```

**Much faster than Hardhat tests!** ⚡
...
| Name              | Type                                         | Slot | Offset | Bytes | Contract                   
                   |
-------------------|
| _walletTokenIds   | mapping(address => uint256[])                | 2    | 0      | 32    | src/TrainingRegistryV1.sol:TrainingRegistryV1 |
|-------------------+----------------------------------------------+------+--------+-------+-----------------------------------------------|
| _hasTokenId       | mapping(address => mapping(uint256 => bool)) | 3    | 0      | 32    | src/TrainingRegistryV1.sol:TrainingRegistryV1 |
|-------------------+----------------------------------------------+------+--------+-------+-----------------------------------------------|
| claimant          | address                                      | 4    | 0      | 20    | src/TrainingRegistryV1.sol:TrainingRegistryV1 |
|-------------------+----------------------------------------------+------+--------+-------+-----------------------------------------------|
| _baseDirectoryURI | string                                       | 5    | 0      | 32    | src/TrainingRegistryV1.sol:TrainingRegistryV1 |
|-------------------+----------------------------------------------+------+--------+-------+-----------------------------------------------|
| uriPadDigits      | uint8                                        | 6    | 0      | 1     | src/TrainingRegistryV1.sol:TrainingRegistryV1 |
|-------------------+----------------------------------------------+------+--------+-------+-----------------------------------------------|
| __gap             | uint256[38]                                  | 7    | 0      | 1216  | src/TrainingRegistryV1.sol:TrainingRegistryV1 |
╰-------------------+----------------------------------------------+------+--------+-------+-----------------------------------------------╯
```
...
✅ **Written Solidity tests** (new skill!)  
✅ **Tested initialization** (claimant, owner, URI)  
✅ **Tested voucher submission** (EIP-712 signatures)  
✅ **Tested soulbound transfers** (must revert)  
✅ **Tested access controls** (onlyOwner, pause)  
✅ **Verified storage layout** (ready for upgrade)  
✅ **Used vm cheatcodes** (prank, expectRevert, expectEmit)  
✅ **Compared to Hardhat tests** (understood the differences)  
...
**Next up:** We'll upgrade to TrainingRegistryV2, adding batch voucher submission for gas savings. You'll see how to safely add new state variables, maintain storage layout, and test the full upgrade process. Ready to upgrade? 🚀
