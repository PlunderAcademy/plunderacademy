...
**Key features:**
- ✅ EIP-712 signed voucher verification
- ✅ Issuer allowlist (controls who can sign vouchers)
- ✅ ERC-1155 soulbound badges (non-transferable achievements)
- ✅ UUPS upgradeable pattern
- ✅ Claimant tracking (proves you deployed it!)
- ✅ Per-wallet achievement tracking
- ✅ Access controls and pause functionality
...
│   └── Initialize-once logic
├── UUPSUpgradeable (OpenZeppelin)
│   └── Upgrade authorization
├── Ownable2StepUpgradeable (OpenZeppelin)
...
<td>✅ Set in constructor</td>
<td>✅ Set in initialize</td>
</tr>
<tr>
...
<td>❌ Soulbound (locked to wallet)</td>
</tr>
</tbody>
</table>
...
**Allows:**
- `from == address(0)` → Minting (creating tokens)
- `to == address(0)` → Burning (destroying tokens)
...
- Example: tokenId 5 → `"https://static.plunderswap.com/training/0005.json"`
...
✅ **Upgradeable patterns**: Initialize instead of constructor, storage gaps  
✅ **EIP-712 vouchers**: Cryptographically secure signatures  
✅ **Claimant tracking**: Same as NFT/Staking, but in initialize  
✅ **Soulbound badges**: Non-transferable ERC-1155 tokens  
✅ **Security**: Issuer controls, replay prevention, pause functionality  
✅ **Production-ready**: Real contract used by this training portal  
...
**Next up:** We'll set up Foundry, compare it to Hardhat, and deploy TrainingRegistry V1 to Zilliqa testnet. Get ready to use Solidity for tests (no more TypeScript!) and see how `forge` commands differ from `hardhat`. Let's go! 🚀
