...
**Key features:**
- ✅ ERC721 standard compliance (marketplace compatible)
- ✅ Fixed supply (100 tokens)
- ✅ Paid minting (1 ZIL default, adjustable)
- ✅ Batch minting support
- ✅ Reveal mechanics (hidden → revealed)
- ✅ Owner controls (pricing, URIs, reveal)
- ✅ Payment withdrawal
- ✅ Claimant tracking (achievement verification)

### Interactive: Contract Components

Explore the different parts of the NFT contract. Click on each component to see what it contains.
...
- `Strings`: Convert uint256 → string for tokenURI
...
2. Users mint → all show hidden.json
...
**Execution flow:**
1. `ERC721(_name, _symbol)` → Initialize parent contract
2. `Ownable(msg.sender)` → Set deployer as owner
3. `require(_claimant != address(0))` → Validate claimant
...
<td>✅ ERC721, Ownable</td>
</tr>
<tr>
<td>Owner controls</td>
<td>✅ APY, fees, rewards</td>
<td>✅ Price, URIs, reveal</td>
</tr>
<tr>
...
### ❌ Revealing Before Metadata Ready
