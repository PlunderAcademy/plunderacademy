...
echo "metadata/" >> .gitignore  # Will be generated in next lesson
```
...
async function main() {
  try {
    ...
    try {
      ...
      console.log("Mint Price:", mintPrice.toString(), "wei (0.01 ETH)");
...
Transaction hash: 0x...
✅ NFT Collection deployed to: 0x5FbDB2315678afecb367f032d93F642f64180aa3

📋 Verifying deployment...
Collection Name: Plunder NFT Collection
Symbol: PNFT
Max Supply: 100
Mint Price: 10000000000000000 wei (0.01 ETH)
Total Minted: 0
Is Revealed: false
Claimant: 0x70997970C51812dc3A010C7d01b50e0d17dc79C8
...
async function main() {
  try {
    ...
    if (error.message?.includes("Exceeds max supply")) {
      ...
      console.log("\n💡 Not enough ETH sent for minting");
    }
...
**Solution:**
```bash
# Make sure you're sending enough ETH/ZIL
# mintPrice * quantity = total payment needed
# Example: 0.01 * 3 = 0.03 ETH
```
