...
> In the practical module, you'll build a fresh Next.js dApp from scratch that integrates wallet connection, contract reading (ERC20 balances, NFT viewing), and contract writing (ERC20 transfers). We'll use the same tech stack as Plunder Academy itself: wagmi 2.x, viem 2.x, and RainbowKit 2.x configured for Zilliqa testnet.
