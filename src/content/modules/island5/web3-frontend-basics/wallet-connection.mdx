...
> Starter Template: For Island 5, begin from `https://github.com/Plunderswap/sample-next-js` as a baseline scaffold (Next.js + wagmi + RainbowKit). We’ll build on that structure and integrate the practical (ERC20 transfer first, later staking or NFT minting).
