...
{"type":"true-false-statements","userResponse":{"classifications":[{"id":"s1","answer":false},{"id":"s2","answer":true},{"id":"s3","answer":false},{"id":"s4","answer":true}]}}
...
<!--
API ANSWER FORMAT for backend validation:
{"type":"drag-drop-puzzle","userResponse":{"sequence":["b1","b2","b3","b4"]}}
CORRECT SEQUENCE: ["b1","b2","b3","b4"]
-->
