...
Every great dApp starts with solid foundations. We'll scaffold a Next.js project, install Web3 dependencies, and configure wagmi + RainbowKit to connect to Zilliqa testnet. By the end of this lesson, you'll have a running app with wallet connection—the hello world of Web3 frontends.
...
- ✅ WalletConnect Cloud account (free) for project ID

> **WalletConnect Project ID:** Go to [cloud.walletconnect.com](https://cloud.walletconnect.com), sign up (free), and create a project. Copy the Project ID—you'll need it in .env.local.

## 🚨 Starting Fresh - Important!

<Callout type="warning">
**Before you begin:** If you completed the Upgradeable Contracts module or any previous practicals, you should close that project and start with a completely new folder. Each practical module should be its own independent project!
</Callout>

**Why start fresh?**
- This is a **Next.js frontend project**, completely different from your Hardhat/Foundry Solidity projects
- Mixing projects leads to confusing file structures and dependency conflicts
...
3. **Create the project** (instructions below)
...
├── zilliqa-rng/               ← Island 4 RNG project
├── training-registry/         ← Island 4 upgradeable project
├── my-token-dapp/             ← Your new Island 5 dApp (create this fresh!)
...
Open your terminal, navigate to your main development directory, and create a new Next.js project:
...
**Version note:** We're using `viem@2.x` and compatible versions—these match Plunder Academy's setup.
...
- **Setup for Zilnames and Multicall3!**: ENS and optimized read calls.
...
- **Nesting order matters**: Wagmi → Query → RainbowKit
...
│   │   ├── page.tsx                ✅ Has ConnectButton
│   │   └── globals.css
│   ├── components/
│   │   └── providers.tsx           ✅ Created
│   ├── lib/
│   │   ├── wagmi.ts                ✅ Configured for Zilliqa
│   │   └── utils.ts                ✅ Helper functions
├── .env.local                      ✅ WalletConnect ID
...
- Ensure providers are in correct order: Wagmi → Query → RainbowKit
...
- Restart VS Code TypeScript server: Cmd+Shift+P → "Restart TypeScript Server"
...
- ✅ wagmi + viem + RainbowKit configured
- ✅ Zilliqa testnet support
- ✅ Wallet connection working
- ✅ Clean project structure

**Next lesson:** We'll build core components—network guard, layout with header/footer, and improve the wallet connection UI. We'll also add dark mode support to match modern dApp standards.
...
**All checked?** Great! Let's build the core components next. 🚀
