...
- Withdraw before lock ends → 5% penalty, no rewards
- Withdraw after lock ends → 2% fee, full rewards paid

✅ **Global reward controls:**
...
- Average APY: 15%
- Annual rewards needed: 500,000 × 0.15 = 75,000 tokens ✅ (fits in pool)
...
- ✅ See the complete flow in one place
- ✅ Easier to understand how pieces connect
- ✅ Lower gas costs (no cross-contract calls)
- ✅ Simpler to audit and deploy
- ✅ Used by many production protocols
...
- ✅ Review contract features and architecture
- ✅ Plan your staking token strategy
...
- **Fresh project setup** (you'll create a new folder, separate from Island 1!)
- Writing deployment scripts with claimant integration
- Zilliqa testnet deployment
- Achievement verification and claiming

<Callout type="info">
**Heads up:** In Module 2.5.3, you'll create a brand new Hardhat project for your staking contract. If you completed the ERC-20 module in Island 1, make sure to close that project first and start fresh in a new folder. Each practical module should be its own independent project!
</Callout>
...
- Annual reward would be: 1000 × 10% = 100 tokens
- For 30 days: 100 × (30/365) = approximately 8.22 tokens
...
**Key concept review:**
- ✅ Staking = locking tokens for a period to earn rewards
- ✅ Longer locks = higher APY rates
- ✅ Early withdrawal = penalty + no rewards
- ✅ Normal withdrawal = small fee + full rewards
- ✅ Each deposit is tracked separately (you can have multiple)

## Wrap-Up

You now understand:
- ✅ What staking contracts do and why they're valuable
- ✅ The architecture of our unified staking contract
- ✅ How `DepositItem` and `UserInfo` structures work
- ✅ Duration tiers, APY rates, and penalty systems
- ✅ Token economics and reward pool planning
- ✅ Key security considerations (reentrancy, SafeERC20, math precision)
...
Ready to see the contract in action? Let's go! 🚀
