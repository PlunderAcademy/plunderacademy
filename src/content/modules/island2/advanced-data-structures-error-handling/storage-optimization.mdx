...
<svg viewBox="0 0 650 280" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <style>
      {`.slot { fill: var(--background); stroke: var(--border); stroke-width: 2; rx: 4; }
        .packed { fill: var(--primary); fill-opacity: 0.15; stroke: var(--primary); stroke-width: 2; }
        .unpacked { fill: var(--destructive); fill-opacity: 0.1; stroke: var(--destructive); stroke-width: 2; }
        ...
        .cost { fill: var(--muted-foreground); font-size: 10px; font-style: italic; }`}
    </style>
  </defs>
  
  {/* Unpacked (Bad) */}
  <text className="label" x="10" y="25" style={{fontWeight: 'bold', fill: 'var(--destructive)'}}>Unpacked (3 slots, 3 SLOAD)</text>
  <rect className="unpacked" x="10" y="40" width="300" height="60" />
  <text className="small" x="20" y="60">Slot 0: uint256 amount</text>
  <text className="small" x="20" y="80">Slot 1: uint256 lastAccruedAt</text>
  <text className="small" x="20" y="95">Slot 2: uint256 flags</text>
  <text className="cost" x="20" y="120">Read all 3: 2,100 + 100 + 100 = 2,300 gas</text>
  <text className="cost" x="20" y="135">Write all 3: 20,000 + 5,000 + 5,000 = 30,000 gas</text>
  
  {/* Packed (Good) */}
  <text className="label" x="10" y="175" style={{fontWeight: 'bold', fill: 'var(--primary)'}}>Packed (1 slot, 1 SLOAD)</text>
  <rect className="packed" x="10" y="190" width="300" height="70" />
  <text className="small" x="20" y="210">Slot 0:</text>
  <text className="small" x="20" y="228">  uint128 amount (128 bits)</text>
  <text className="small" x="20" y="244">  uint64 lastAccruedAt (64 bits)</text>
  <text className="small" x="20" y="260">  uint64 flags (64 bits)</text>
  <text className="cost" x="320" y="220">Read: 2,100 gas (1 SLOAD)</text>
  <text className="cost" x="320" y="240">Write: 20,000 gas (1 SSTORE)</text>
  <text className="small" x="320" y="260" style={{fill: 'var(--primary)', fontWeight: 'bold'}}>✓ Saves 200 gas/read, 10k gas/write</text>
  
  {/* Visual slot representation */}
  <text className="label" x="350" y="25">256-bit Slot Layout:</text>
  <rect className="slot" x="350" y="40" width="280" height="40" />
  <rect className="packed" x="350" y="40" width="140" height="40" />
  <text className="small" x="370" y="65" textAnchor="start">uint128 (128 bits)</text>
  <rect className="packed" x="490" y="40" width="70" height="40" />
  <text className="small" x="505" y="65" textAnchor="start" style={{fontSize: '9px'}}>uint64</text>
  <rect className="packed" x="560" y="40" width="70" height="40" />
  <text className="small" x="575" y="65" textAnchor="start" style={{fontSize: '9px'}}>uint64</text>
</svg>
