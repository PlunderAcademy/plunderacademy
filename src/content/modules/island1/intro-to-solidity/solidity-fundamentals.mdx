...
<TrueFalse statements={[
  {"id": "sol-1", "text": "Solidity is statically typed - you must declare variable types", "correctAnswer": true, "explanation": "Solidity requires explicit type declarations like uint256, address, etc."},
  {"id": "sol-2", "text": "The 'public' keyword automatically creates a getter function", "correctAnswer": true, "explanation": "Public state variables automatically get a getter function generated"},
  {"id": "sol-3", "text": "Solidity supports multiple inheritance from other contracts", "correctAnswer": true, "explanation": "Contracts can inherit from multiple parent contracts using 'is' keyword"},
  {"id": "sol-4", "text": "Variables declared inside functions persist after execution", "correctAnswer": false, "explanation": "Local variables only exist during function execution - use state variables for persistence"}
]} />

This interactive exercise reinforces key Solidity fundamentals you've learned in this lesson.
