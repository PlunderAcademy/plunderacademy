...
### Network Configuration (Mainnet/Testnet Toggle)
...
- Connects wallets to the correct Zilliqa network (Mainnet Chain ID 32769 or Testnet Chain ID 33101)
- Uses the appropriate API endpoint and contract addresses
- Configures the correct RPC URLs and block explorers
...
3. **Test your changes** thoroughly (run `npm run lint` before submitting)
4. **Submit a pull request** with a clear description of what you've changed and why

### Contribution Guidelines

- Follow the existing code style and conventions (Tailwind utility classes + Radix primitives)
- Prefer MDX for written curriculum
- Add tests for new features
- Update documentation as needed
- Keep commits focused and atomic
- Write clear commit messages
- When adding AI prompts or missions, keep spoilers in separate markdown files so they can be iterated without code changes
...
- **Licensor**: Abbika LLC
- **Licensed Work**: PlunderAcademy (© 2025 Abbika LLC) - https://github.com/Plunderswap/plunderacademy
